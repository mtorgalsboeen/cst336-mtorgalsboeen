				...
				<div id="nav_wrapper"><br>
					<ul class="clearfix">
						...
						<li>
							<a href="#">Labs</a>
								<ul>
									<li><a href="labs/lab1/lab1.php">Lab 1</a></li>
									<li><a href="labs/lab2/index.php">Lab 2</a></li>
									<li><a href="labs/silverjack_lab3_team10/index.php">Lab 3</a></li>
									...
									<li><a href="labs/lab9/index.php">Lab 9</a></li>									
								</ul>
						</li>	
						<li>
							<a href="#">Homeworks</a>
								<ul>
									...
									<li><a href="homework/hw3/homework3.php">Homework 3</a></li>
		...
		<div>
			<table style="width:50%">
  				<tr>
    				...
    				<th>Torgalsboeen</th> 
    				<th>21</th>
    				<th>Birthday: 8.may</th>
  				</tr>
			</table>
		</div>
		<div class="maincontent">
			<div id="image">
				<img src="Images/myImage.jpg" alt="Picture of me." style="height:250px", "width:400px", "border:1px dashed DarkSlateBlue"></img>
			</div>
			<div id="bio">
				<h2>Mathias Torgalsboeen</h2>
				<p>I'm an exchange student from Norway that studies Computer Science and Business. I'm 21 years old and enjoy to travel and explore.</p>
				<p>I also have a lot interest in cryptocurrency and blockchain technology and use much of my time learning more and develop my skills in the blockchain technology.</p><br />
			</div>
		</div>
		<div class="footer">
