<form>
    ...
    <input type="radio" name="question3" id="q3-1"  value="A"/><label for='q3-1'>1 <br />
    <input type="radio" name="question3" id="q3-2"  value="B"/><label for='q3-2'>2 <br />
    <input type="radio" name="question3" id="q3-3"  Value="C"/><label for='q3-3'>3 <br />
